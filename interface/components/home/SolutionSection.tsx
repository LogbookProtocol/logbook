    ...
    <section className="py-20 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          <FeatureCard
            title="Rules = Code"
            description={<>Voting logic in smart contract. No platform can change the rules mid-vote. <a href="/docs?doc=smart-contract" className="text-cyan-600 dark:text-cyan-400 hover:underline">Learn more →</a></>}
          />
          <FeatureCard
